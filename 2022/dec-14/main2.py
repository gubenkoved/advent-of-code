...
# make the field bigger to make sure we have enough space
field = [
    ['.'] * ((max_col + 1) * 2)  # ensure we have enough space
    for _ in range(max_row + 1 + 2)
]
...
while True:
    ...
    # stop when the sand did not move from the starting position
    if pos == (500, 0):
        break
